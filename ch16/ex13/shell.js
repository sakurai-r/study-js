    ...
    case ">": // RedirCmd
      {
        ...
        const leftStream = fs.createWriteStream(cmd.file);
        await runcmd(cmd.cmd, stdin, leftStream);
      }
      break;
    ...
    case "<": // RedirCmd
      {
        ...
        await runcmd(cmd.cmd, rightStream, stdout);
      }
      break;
    ...
    case "|": // PipeCmd
      {
        ...
        await Promise.all([
          runcmd(cmd.left, stdin, pipeStream),
          runcmd(cmd.right, pipeStream, stdout),
        ]);
      }
      break;
